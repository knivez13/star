            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Briefing Logs</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title">Briefing Logs</h4>
                <div class="box-controls pull-right">
                    <div class="form-group mb-0">
                        <span class="input-group-btn">
                            <a href="{{ route('briefing-logs.create') }}" class="btn btn-primary bootstrap-touchspin-up btn-sm"> Add New</a>
                        </span>
                    </div>
                </div>
            </div>
            <div class="box-body no-padding">
                <form action="{{ route('briefing-logs.index') }}" method="POST">
                    @csrf
                    @method('GET')
                    <div class="p-10">
                        <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @forelse($datas as $a)
                        <tr>
                            <td style="margin: 0; white-space: nowrap;"><a href="{{ route('briefing-logs.edit', $a->id) }}">{{ $a->inv_no }}</a></td>
