            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Briefing Logs</li>
...
<section class="content ">
    <form action="{{ route('briefing-logs.store') }}" method="POST">
        @csrf
        @method('POST')
        <div class="col-12 col-lg-6">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Create Briefing Logs</h4>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="origination_id" value="{{ old('origination_id') }}">
                                ...
                                @foreach ($origin as $a)
                                <option value="{{$a->id}}" {{$a->id == old('origination_id')? 'selected':''}}>{{$a->description}}</option>
                                @endforeach
                            </select>
                ...
                <div class="box-footer text-end">
                    ...
                    <a href="{{ route('briefing-logs.index') }}" class="btn btn-warning btn-sm me-1">
