            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Inspector</li>
...
<section class="content">
    <form action="{{ route('inspector.update',$data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="col-12 col-lg-4">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Edit Inspector</h4>
                </div>
                ...
                <div class="box-footer text-end">
                    ...
                    <a href="{{ route('inspector.index') }}" class="btn btn-warning btn-sm me-1">
