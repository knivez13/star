                        ...
                        <form action="{{ route('area.index') }}" method="POST">
                            ...
                            <div class="input-group bootstrap-touchspin ">
                                ...
                                <span class="input-group-btn">
                                    <a href="{{ route('area.create') }}" class="btn btn-primary bootstrap-touchspin-up btn-sm"> Add New</a>
                                </span>
                            </div>
                        </form>
                    </div>
            ...
            <div class="box-body no-padding">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @forelse($datas as $a)
                        <tr>
                            <td style="margin: 0; white-space: nowrap;"><a href="{{ route('area.edit', $a->id) }}">{{ $a->code }}</a></td>
