            ...
            <div class="box-header with-border">
                ...
                <div class="box-controls pull-right">
                    <div class="form-group mb-0">
                        <form action="{{ route('blacklist-status.index') }}" method="POST">
                            @csrf
                            @method('GET')
                            <div class="input-group bootstrap-touchspin ">
                                ...
                                <span class="input-group-btn">
                                    <a href="{{ route('blacklist-status.create') }}" class="btn btn-primary bootstrap-touchspin-up btn-sm"> Add New</a>
                                </span>
                            </div>
                        </form>
                    </div>
