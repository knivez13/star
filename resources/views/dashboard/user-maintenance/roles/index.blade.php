                        ...
                        <form action="{{ route('roles.index') }}" method="POST">
                            ...
                            <div class="input-group bootstrap-touchspin ">
                                ...
                                <span class="input-group-btn">
                                    <a href="{{ route('roles.create') }}" class="btn btn-primary bootstrap-touchspin-up btn-sm"> Add New</a>
                                </span>
                            </div>
                        </form>
                    </div>
            ...
            <div class="box-body no-padding">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @forelse($datas as $a)
                        <tr>
                            <td style="margin: 0; white-space: nowrap;"><a href="{{ route('roles.edit', $a->id) }}">{{ $a->name }}</a></td>
                            <td>
                                @foreach ( $a->permissions as $b)
                                <span class="badge badge-pill badge-info-light mb-1"> {{$b->name}}
                                </span>
                                @endforeach
                            </td>
