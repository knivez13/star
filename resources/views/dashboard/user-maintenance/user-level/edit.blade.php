...
<section class="content">
    <form action="{{ route('user-level.update',$data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="col-12 col-lg-4">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Edit Level</h4>
                </div>
                ...
                <div class="box-footer text-end">
                    ...
                    <a href="{{ route('user-level.index') }}" class="btn btn-warning btn-sm me-1">
